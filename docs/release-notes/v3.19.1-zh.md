...
访问 [Releases](https://github.com/farion1231/cc-switch/releases/latest) 下载对应版本，或从官网 [libra.irises.cc](https://libra.irises.cc) 获取（下载经 Cloudflare 边缘节点分发，不依赖 GitHub 可达）。
