  ...
  return (
    <div className="flex h-full flex-col overflow-hidden bg-background">
      {isBusy ? (
        ...
        >
          <TabsList className="mb-0 grid h-auto w-full grid-cols-6 gap-0 rounded-none border-b border-border bg-muted/30 p-0">
            <TabsTrigger
              value="general"
              className="min-w-0 rounded-none border-b-2 border-transparent bg-transparent px-2 py-3 text-xs data-[state=active]:border-blue-500 data-[state=active]:bg-transparent data-[state=active]:text-foreground data-[state=active]:shadow-none sm:text-sm"
            >
          ...
          <div className="flex-1 min-h-0 flex flex-col">
            <div
              ...
              className="flex-1 overflow-x-hidden overflow-y-auto px-6 py-4"
            >
              ...
              <TabsContent value="proxy" className="mt-0 space-y-4 pb-4">
                {settings ? (
                  <ProxyTabContent
                    settings={settings}
                ...
                {settings ? (
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <AccordionTrigger className="px-4 py-3 hover:no-underline hover:bg-muted/60 data-[state=open]:bg-muted/60">
              ...
              >
                <div className="flex items-center justify-end gap-3">
                  <Button
                    onClick={handleSave}
                    disabled={isSaving}
                    className="rounded-none bg-blue-600 hover:bg-blue-500"
                  >
                    {isSaving ? (
      ...
      >
        <DialogContent
          zIndex="alert"
          className="max-w-md border-border bg-background shadow-2xl sm:rounded-none"
        >
          <DialogHeader>
