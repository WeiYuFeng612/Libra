...
export function ProviderCard({
  ...
  return (
    <div
      className={cn(
        "group relative overflow-hidden border border-border bg-card p-3 text-card-foreground transition-colors",
        isAutoFailoverEnabled || isProxyTakeover
          ? "hover:border-emerald-500/60 hover:bg-emerald-500/5"
          : "hover:border-blue-500/60 hover:bg-muted/30",
        shouldUseGreen && "border-emerald-500/70 border-l-2 bg-emerald-500/5",
        shouldUseBlue && "border-blue-500/70 border-l-2 bg-blue-500/5",
        dragHandleProps?.isDragging &&
          "z-10 cursor-grabbing border-primary bg-muted shadow-lg",
      )}
    >
      ...
      <div className="relative flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex min-w-0 flex-1 items-center gap-2">
          <button
            type="button"
            className={cn(
              "-ml-1 flex-shrink-0 cursor-grab p-1.5 active:cursor-grabbing",
          ...
          <div className="flex h-8 w-8 flex-shrink-0 items-center justify-center border border-border bg-muted">
            <ProviderIcon
          ...
          <div className="min-w-0 flex-1 space-y-0.5">
            <div className="flex min-h-6 flex-wrap items-center gap-2">
              ...
              {isOmo && (
                <span className="inline-flex items-center rounded-sm bg-violet-100 px-1.5 py-0.5 text-[10px] font-semibold text-violet-700 dark:bg-violet-900/40 dark:text-violet-300">
                  OMO
                </span>
              )}

              {isOmoSlim && (
                <span className="inline-flex items-center rounded-sm bg-indigo-100 px-1.5 py-0.5 text-[10px] font-semibold text-indigo-700 dark:bg-indigo-900/40 dark:text-indigo-300">
                  Slim
                </span>
              )}
              ...
              {appId === "claude-desktop" &&
                providerNeedsRouting(appId, provider) && (
                  <span className="inline-flex items-center rounded-sm bg-sky-100 px-1.5 py-0.5 text-[10px] font-semibold text-sky-700 dark:bg-sky-900/40 dark:text-sky-300">
              ...
              {appId === "claude" && provider.category === "official" && (
                <span className="inline-flex items-center rounded-sm bg-slate-200 px-1.5 py-0.5 text-[10px] font-semibold text-slate-700 dark:bg-slate-700/60 dark:text-slate-200">
              ...
              {isHermesReadOnly && (
                <span
                  className="inline-flex items-center rounded-sm bg-slate-200 px-1.5 py-0.5 text-[10px] font-semibold text-slate-700 dark:bg-slate-700/60 dark:text-slate-200"
            ...
            <div className="flex items-center gap-1">
              ...
              {hasMultiplePlans && (
                <button
                  ...
                  className="flex-shrink-0 p-1 text-gray-500 transition-colors hover:bg-muted dark:text-gray-400"
                  title={
                    isExpanded
