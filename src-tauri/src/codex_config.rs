...
/// provider is routed through Libra.  A dedicated id is an ownership
...
pub fn apply_codex_official_proxy_route(
    ...
    // Clean only Libra's placeholder from every stale provider table. Real
...
/// Whether a live Codex config is the official route projected by Libra.
...
/// Remove only the official takeover route owned by Libra. This is a
